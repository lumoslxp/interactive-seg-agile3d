...
from engine_automask import evaluate, train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/mnt/cloud_disk/lxp/AGILE3D-main/output/2024-09-13-12-14-27/results/ScanNet_multi',
                        help='path where to save, empty for no saving')
    
    parser.add_argument('--num_workers', default=2, type=int)
    parser.add_argument('--checkpoint', default='/mnt/cloud_disk/lxp/AGILE3D-main/output/2024-09-13-12-14-27/checkpoint0039.pth', help='resume from checkpoint')
...
def Evaluate(model, data_loader, args, device):
    ...
    # results_file = '/mnt/cloud_disk/lxp/AGILE3D-main/results/our_multi_scannet.csv'
