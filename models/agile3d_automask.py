...
from models.res16unet import AutoR_mask
from .backbone import build_backbone

import itertools

class Agile3d(nn.Module):
    def __init__(self, backbone,mask_backbone, hidden_dim, num_heads, dim_feedforward,
    ...
    def forward_backbone(self, x):
        pcd_features, pcd_feature_maps, offsets = self.backbone(x)

        return pcd_features, pcd_feature_maps, offsets
    
    def forward_mask_backbone(self, mask, pcd_feature_maps, raw_coordinates=None):
        mask_features = self.mask_backbone(mask, pcd_feature_maps)
        ...
        return mask_features, coordinates, pos_encodings_pcd
    
    def forward_mask(self, pcd_features, coordinates, pos_encodings_pcd, click_idx=None, click_time_idx=None):
        ...
        out= {
            ...
            'mask_backbone_features': pcd_features
        }
...
def build_agile3d(args):
    ...
    # mask_backbone = AutoR_mask(32, 20, args)
