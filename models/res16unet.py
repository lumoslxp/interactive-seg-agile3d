...
class Res16UNetBase(ResNetBase):
    ...
    def forward(self, x):
        ...
        out = self.bn1(out)
        out = self.relu(out) # [182124, 32]
        out_b1p2 = self.block1(out) # [182124, 32]

        # feature_maps.append(out)

        out = self.conv2p2s2(out_b1p2)
        out = self.bn2(out)
        out = self.relu(out) # [50613, 32]
        out_b2p4 = self.block2(out) # [50613, 64]

        # feature_maps.append(out)

        out = self.conv3p4s2(out_b2p4)
        out = self.bn3(out)
        out = self.relu(out) # [13499, 64]
        out_b3p8 = self.block3(out) # [13499, 128]
        ...
        out = self.bn4(out)
        out = self.relu(out) # [3511, 128]
        out = self.block4(out) # [3511, 256]
        ...
        out = self.bntr4(out)
        out = self.relu(out) # [13499, 256]

        out = me.cat(out, out_b3p8) # [13499, 384]
        out = self.block5(out) # [13499, 256]

        # pixel_dist=4
        out = self.convtr5p8s2(out)
        out = self.bntr5(out)
        out = self.relu(out) # [50613, 128]

        out = me.cat(out, out_b2p4) # [50613, 192]
        out = self.block6(out) # [50613, 128]

        # pixel_dist=2
        out = self.convtr6p4s2(out)
        out = self.bntr6(out)
        out = self.relu(out) # [182124, 96]

        out = me.cat(out, out_b1p2) # [182124, 128]
        out = self.block7(out) # [182124, 96]

        # pixel_dist=1
        out = self.convtr7p2s2(out)
        out = self.bntr7(out)
        out = self.relu(out) # [497162, 96]

        out = me.cat(out, out_p1) # [497162, 128]
        out = self.block8(out) # [497162, 96]
...
class AutoR_mask(ResNetBase):
    ...
    def forward(self, x, feature_maps):        
        ...
        # AAT_1 = feature_maps[0].F@feature_maps[0].F.T
        # out_p1 = me.SparseTensor(
        #     features=AAT_1@out_p1.F,
        #     coordinate_manager=out_p1.coordinate_manager, 
        #     coordinate_map_key=out_p1.coordinate_map_key 
        # )
        ...
        # AAT_2 = feature_maps[1].F@feature_maps[1].F.T
        # out_b1p2 = me.SparseTensor(
        #     features=AAT_2@out_b1p2.F,
        #     coordinate_manager=out_b1p2.coordinate_manager, 
        #     coordinate_map_key=out_b1p2.coordinate_map_key 
        # )
        ...
        # AAT_3 = feature_maps[2].F@feature_maps[2].F.T
        # out_b2p4 = me.SparseTensor(
        #     features=AAT_3@out_b2p4.F,
        #     coordinate_manager=out_b2p4.coordinate_manager, 
        #     coordinate_map_key=out_b2p4.coordinate_map_key 
        # )
        ...
        # AAT_4 = feature_maps[3].F@feature_maps[3].F.T
        # out_b3p8 = me.SparseTensor(
        #     features=AAT_4@out_b3p8.F,
        #     coordinate_manager=out_b3p8.coordinate_manager, 
        #     coordinate_map_key=out_b3p8.coordinate_map_key 
        # )
        ...
        AAT_5 = feature_maps[4].F@feature_maps[4].F.T
        out = me.SparseTensor(
            features=AAT_5@out.F,
